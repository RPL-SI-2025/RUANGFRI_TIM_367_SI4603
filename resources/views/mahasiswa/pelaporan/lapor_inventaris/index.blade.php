            ...
            <div class="header-left">
                <div class="header-icon-wrapper">
                    <div class="header-icon-bg">
                        <i class="fa fa-clipboard-check header-icon"></i>
                    </div>
                ...
                <div class="header-text">
                    ...
                    <p class="header-subtitle">
                        ...
                        Kelola dan pantau laporan pengembalian inventaris Anda
                    </p>
                    <div class="header-breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Laporan Inventaris</span>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body p-0">
                                ...
                                <tr class="hover-row">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="action-buttons d-flex justify-content-center gap-1">
                                            <a href="{{ route('mahasiswa.pelaporan.lapor_inventaris.show', $item->id_lapor_inventaris) }}" 
                                               class="btn-link-action text-primary text-decoration-none fw-medium"
                                               data-bs-toggle="tooltip" title="Lihat Detail">
                                                Detail
                                            </a>
                                            <span class="text-muted mx-1">/</span>
                                            <a href="{{ route('mahasiswa.pelaporan.lapor_inventaris.edit', $item->id_lapor_inventaris) }}" 
            ...
            @else
                ...
                <div class="empty-state text-center py-5">
                    <div class="py-4">
                        <div class="mb-4">
                            <i class="fa fa-clipboard-list display-1 text-muted opacity-50"></i>
                        </div>
                        <h4 class="text-muted mb-3 fw-bold">Belum ada laporan inventaris</h4>
                        <p class="text-muted mb-4 lead">
                            Laporan akan muncul saat Anda menyelesaikan peminjaman inventaris
                        </p>
