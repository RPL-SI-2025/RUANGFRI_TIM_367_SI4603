        ...
        <div class="col-md-12 col-lg-10 col-xl-9">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="text-white mb-1 fw-bold">Detail Riwayat Peminjaman Ruangan</h4>
                                <p class="text-white-50 mb-3">Informasi lengkap riwayat peminjaman dan pelaporan ruangan</p>
                        ...
                        <a href="{{ route('mahasiswa.history.ruangan.index') }}" 
            ...
            <div class="section-card mb-4">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">Detail data peminjaman dan pelaporan ruangan</p>
                    </div>
                </div>
            ...
            <div class="section-card mb-4">
                <div class="section-header">
                    ...
                    <div>
                        <h5 class="section-title">Daftar Ruangan</h5>
                        <p class="section-subtitle">Ruangan yang dipinjam dan dilaporkan</p>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-modern">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-0 text-center" width="120">Lokasi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php 
                                    $totalItems = count($relatedItems); 
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="inventaris-info-compact">
                                                <h6 class="mb-1">{{ $item->ruangan->nama_ruangan ?? '-' }}</h6>
                                                @if($item->ruangan && $item->ruangan->deskripsi)
                                                    <small class="text-muted">
                                                        <i class="fa fa-info-circle me-1"></i>
                                                        {{ Str::limit($item->ruangan->deskripsi, 50) }}
                                                    </small>
                                                @endif
                                            </div>
                                        </td>
            ...
            <div class="section-card mb-4">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">File dan foto terkait peminjaman ruangan</p>
                    </div>
                </div>
