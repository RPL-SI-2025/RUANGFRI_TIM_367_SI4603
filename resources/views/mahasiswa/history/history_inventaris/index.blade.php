        ...
        <div class="header-content">
            <div class="header-left">
                ...
                <div class="header-text">
                    <h1 class="header-title">
                        Riwayat Peminjaman
                        <span class="header-title-highlight">& Pelaporan</span>
                    </h1>
                    <p class="header-subtitle">
                        <i class="fa fa-chart-line me-2"></i>
                        Lihat riwayat lengkap peminjaman dan pelaporan inventaris yang telah selesai
                    </p>
                    <div class="header-breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Riwayat Inventaris</span>
                    </div>
                </div>
            </div>
            <div class="header-right">
                <div class="header-stats">
                    <div class="stat-card">
                        <div class="stat-number">{{ count($paginatedInventaris) }}</div>
                        <div class="stat-label">Total Riwayat</div>
                        <div class="stat-indicator stat-success"></div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">{{ count($paginatedInventaris->where('foto_awal')) }}</div>
                        <div class="stat-label">Dengan Foto</div>
                        <div class="stat-indicator stat-info"></div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">{{ $paginatedInventaris->where('created_at', '>=', \Carbon\Carbon::now()->startOfWeek())->count() }}</div>
                        <div class="stat-label">Minggu Ini</div>
                        <div class="stat-indicator stat-warning"></div>
                    </div>
                </div>
                <div class="header-actions">
                    <a href="{{ route('mahasiswa.peminjaman.pinjam-inventaris.index') }}" class="btn-futuristic btn-primary-futuristic">
    ...
    <div class="card border-0 shadow-lg main-card">
        <div class="card-header bg-gradient-primary text-white py-3 border-0 card-header-futuristic">
            ...
            <div class="d-flex align-items-center position-relative">
                ...
                <h5 class="mb-0 fw-bold">Riwayat Peminjaman Inventaris</h5>
            ...
            @if(count($paginatedInventaris) > 0)
                                ...
                                <tr class="hover-row">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="action-buttons d-flex justify-content-center gap-1">
                                            <a href="{{ route('mahasiswa.history.inventaris.show', ['inventaris', $item->id_lapor_inventaris]) }}" 
                ...
                <div class="d-flex justify-content-center py-4 border-top pagination-wrapper">
                    <div class="pagination-container">
                        {{ $paginatedInventaris->links('pagination.custom-pagination') }}
                    </div>
                </div>
            @else
                <!-- Empty State -->
                <div class="empty-state text-center py-5">
                    <div class="py-4">
                        <div class="mb-4">
                            <i class="fa fa-history display-1 text-muted opacity-50"></i>
                        </div>
                        <h4 class="text-muted mb-3 fw-bold">Belum ada riwayat peminjaman inventaris</h4>
                        <p class="text-muted mb-4 lead">
                            Riwayat akan muncul setelah Anda menyelesaikan peminjaman dan pelaporan inventaris
                        </p>
