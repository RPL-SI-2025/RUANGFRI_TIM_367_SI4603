    ...
    <div class="card border-0 shadow-lg mb-4">
        <div class="card-header text-white py-3 border-0 card-header-futuristic"
            ...
            <div class="d-flex align-items-center">
                <i class="fas fa-trash-alt me-3 fs-5 text-white"></i>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-danger" id="toggleDeleteSection">
            ...
            <div id="deleteAccountSection" style="display: none; margin-top: 1rem;">
                <div class="card border-danger mt-3 shadow-sm">
